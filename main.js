...
mouseclick.src = "./mixkit-single-classic-click-1116.wav";
...
let getMode = localStorage.getItem("mode2");
...
toggleBtn.addEventListener("click", () => {
  ...
  if (!app.classList.contains("light")) {
    localStorage.setItem("mode2", "dark-mode");
  } else {
    localStorage.setItem("mode2", "light-mode");
  }
